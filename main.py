...
# ဒီအောက်က String နေရာမှာ စောစောက အသစ်ရတဲ့ String ကို သေချာထည့်ပါ
...
# StringSession ထဲကို MY_SESSION တိုက်ရိုက်ထည့်ထားပါတယ်
...
async def main():
    ...
    # client.start() မှာ ဘာမှထပ်မတောင်းအောင် စီစဉ်ထားပါတယ်
    await client.start() 
    print("Bot is online!")
